...
import { collection, getDocs, doc, setDoc, serverTimestamp, updateDoc, query, where, collectionGroup } from 'firebase/firestore';
import { db } from '../../firebase';
import { Plus, Trash2, Users, CheckCircle, Archive, Copy, Eye, ToggleLeft, Check, X, ChevronDown } from 'lucide-react';
...
export const TeacherHomework = ({ currentUser }: { currentUser: any }) => {
  ...
  const [showCheckSubmissions, setShowCheckSubmissions] = useState(false);
  ...
  const [selectedSubmissionHomeworkId, setSelectedSubmissionHomeworkId] = useState<string | null>(null);
